...
import time
import uuid
assets = SoftwareAsset.objects.get(pk=1)
...
#     template_name = "landingpage/base3.html"
...
#         data = {
#             "mode": "0011",
#             "callbackURL": "https://skillnest-academy.xyz/enroll",
#             "amount": str(amount),
#             "currency": "BDT",
#             "intent": "sale",
#             "merchantInvoiceNumber": merchant_invoice,
#             "payerReference": "Skill Nest"
#         }
#         response = requests.post(url, json=data, headers=headers)
#         response_data = response.json()
...
#     template_name = "landingpage/success.html"
...
#         }
#         return render(request, self.template_name, context)
# class CustomErrorPageView(TemplateView):
#     template_name = "landingpage/error_page.html"   
...
#     event_source_url = event_source_url or "https://skillnest-academy.xyz/"
...
#             return redirect("dashboard")  # Replace with your dashboard/homepage URL
#         else:
...
#     def get(self, request, *args, **kwargs):
#         # Fetch the last purchase
#         last_purchase = Purchase.objects.last()
#         purchase_id = last_purchase.id if last_purchase else None
        
#         # Trigger the conversion API with the required parameters
#         browser_id = request.COOKIES.get('browser_id')  # Assuming browser_id is stored in cookies
#         click_id = request.GET.get('click_id')  # Assuming click_id is passed in the URL query parameters
#         conversion_api(last_purchase, "Page View", browser_id, click_id)
        
#         # Render the template with any context you need
#         context = {
...
#     template_name = "landingpage/dashboard.html"
# class OrdersView(LoginRequiredMixin, TemplateView):
#     template_name = "landingpage/orders.html"
...
# class ThemeTemplateView(TemplateView):
#     template_name = 'landingpage/base3.html'

#     def get_context_data(self, **kwargs):
#         context = super().get_context_data(**kwargs)
#         # Get the theme instance
#         theme_id = kwargs.get('page_id')
